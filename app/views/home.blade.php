...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="post-title"><span class="label label-cat-{{ $post->category }}">{{ $categories[$post->category] }}</span> <a href="{{ URL::to('posts/' . $post->id) }}">{{ $post->title }}</a> <small>[<a href="#" title="코멘트">1</a>]<small></td>
